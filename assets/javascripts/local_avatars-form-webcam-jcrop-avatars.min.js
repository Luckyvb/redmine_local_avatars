...
/* jQuery AS3 Webcam; v20131227 https://github.com/sshilko/jQuery-AS3-Webcam */
try{$(document).ready(function(){var a={previewWidth:320,previewHeight:240,resolutionWidth:320,resolutionHeight:240,videoDeblocking:0,videoSmoothing:0,StageScaleMode:"exactFit",StageAlign:"",cameraId:"AS3webcamObject",callTarget:"webcam",bgcolor:"#000000",isSwfReady:!1,isCameraEnabled:!1,swffile:"sAS3Cam.swf",cameraEnabled:function(){},cameraDisabled:function(){},noCameraFound:function(){},isClientReady:function(){return!0},cameraReady:function(){},cameraConnected:function(){this.isSwfReady=!0;var a=document.getElementById(this.cameraId);this.save=function(){try{return a.save()}catch(b){this.swfApiFail(b)}},this.saveAndPost=function(b){try{return a.saveAndPost(b)}catch(c){this.swfApiFail(c)}},this.setCamera=function(b){try{return a.setCamera(b)}catch(c){this.swfApiFail(c)}},this.getCameraList=function(){try{return a.getCameraList()}catch(b){this.swfApiFail(b)}},this.getResolution=function(){try{return a.getResolution()}catch(b){this.swfApiFail(b)}},this.cameraReady()},init:function(b,c){if("object"==typeof c)for(var d in a)void 0!==c[d]&&(a[d]=c[d]);var e='<object id="'+this.cameraId+'" type="application/x-shockwave-flash" data="'+a.swffile+'" width="'+a.previewWidth+'" height="'+a.previewHeight+'"><param name="movie" value="'+a.swffile+'" /><param name="FlashVars" value="callTarget='+this.callTarget+"&resolutionWidth="+a.resolutionWidth+"&resolutionHeight="+a.resolutionHeight+"&smoothing="+a.videoSmoothing+"&deblocking="+a.videoDeblocking+"&StageScaleMode="+a.StageScaleMode+"&StageAlign="+a.StageAlign+'" /><param name="allowScriptAccess" value="always" /><param name="bgcolor" value="'+a.bgcolor+'" /></object>';return $(b).html(e),this},swfApiFail:function(){},debug:function(){}};window.webcam=a,$.fn.webcam=function(b){return a.init(this,b)}})}catch(e){}
...
/* jquery.avatars.js; v20131228 https://github.com/thorin/redmine_local_avatars - license: GPL v2 */
jQuery(function(a){"use strict";a.widget("avatars.cropper",{options:{previewContainer:"#preview-box",cropXElem:"#crop_x",cropYElem:"#crop_y",cropWElem:"#crop_w",cropHElem:"#crop_h",$previewOverflow:null,$previewElem:null,$cropboxElem:null,$cropboxContainer:null,img_width:1,img_height:1,edit_width:0,edit_height:0,preview_width:0,preview_height:0,hidden_preview:null,hidden_cropbox:null},_create:function(){var b=this.options;b.$cropboxContainer=this.element,b.preview_width=a(b.previewContainer).width(),b.preview_height=a(b.previewContainer).height()},start:function(b){var c=this.options,d=this;a("<img>",{src:b}).load(function(){c.img_width=this.width,c.img_height=this.height,d._initElements(b),c.$cropboxElem.load(function(){c.edit_width=c.$cropboxElem.width(),c.edit_height=c.$cropboxElem.height(),d._initJcrop()}),this.remove()})},stop:function(){var b=this.options;a(b.$cropboxContainer).contents().remove(),b.$previewOverflow.remove(),a(b.previewContainer+" img").show()},_initJcrop:function(){var a=this.options,b=this,c=Math.min(a.edit_width,a.edit_height),d=Math.max(0,(a.edit_width-c)/2);a.$cropboxElem.Jcrop({onChange:b._updateCrop.bind(b),onSelect:b._updateCrop.bind(b),setSelect:[d,0,c,c],aspectRatio:1})},_initElements:function(b){var c=this.options;a(c.previewContainer+" img").hide(),c.$previewOverflow=a("<div>").css("overflow","hidden"),c.$previewElem=a("<img>",{src:b}),c.$previewElem.appendTo(c.$previewOverflow),c.$previewOverflow.appendTo(c.previewContainer),c.$cropboxElem=a("<img>",{"class":"cropbox",src:b}),c.$cropboxElem.appendTo(c.$cropboxContainer),a.each([c.cropX,c.cropY,c.cropW,c.cropH],function(b,d){a("<input>",{name:d,type:"hidden"}).appendTo(c.$cropboxContainer)})},_updateCrop:function(b){var c=this.options,d=c.edit_width*c.preview_width/b.w,e=c.edit_height*c.preview_height/b.h,f=b.x*c.preview_width/b.w,g=b.y*c.preview_height/b.h;c.$previewElem.css({width:Math.round(d)+"px",height:Math.round(e)+"px",marginLeft:"-"+Math.round(f)+"px",marginTop:"-"+Math.round(g)+"px"});var h=c.img_width/c.edit_width,i=c.img_height/c.edit_height;a("[name="+c.cropX+"]",c.$cropboxContainer).val(Math.round(b.x*h)),a("[name="+c.cropY+"]",c.$cropboxContainer).val(Math.round(b.y*i)),a("[name="+c.cropW+"]",c.$cropboxContainer).val(Math.round(b.w*h)),a("[name="+c.cropH+"]",c.$cropboxContainer).val(Math.round(b.h*i))},destroy:function(){this.options,this.stop(),a.Widget.prototype.destroy.call(this)}}),a.widget("avatars.photographer",{options:{resolutionWidth:null,resolutionHeight:null,swffile:"sAS3Cam.swf",captureButton:"#capture-webcam",startButton:"#start-webcam",stopButton:"#stop-webcam",camerasSelect:"#capture-cameras select",filename:null,filefield:null,postUrl:"#",postData:{},StageScaleMode:"noScale",StageAlign:"TL",previewWidth:null,previewHeight:null,isCameraEnabled:!1,cameraApi:null},_create:function(){var b=this.options,c=this;this.element.attr("id","photographer_"+this._random()),this._initOptions(),a(b.stopButton).click(function(a){a.preventDefault(),c.stop()}),a(b.startButton).click(function(a){a.preventDefault(),c.start()})},_initOptions:function(){var b=this.options;b.previewWidth=a(this.element).width(),b.previewHeight=a(this.element).height(),null===b.filename&&(b.filename=this._random()+".jpg"),null===b.resolutionWidth&&(b.resolutionWidth=b.previewWidth),null===b.resolutionHeight&&(b.resolutionHeight=b.previewHeight)},disable:function(){a(this.options.startButton).prop("disabled",!0)},enable:function(){a(this.options.startButton).prop("disabled",!1)},start:function(){var b=this.options,c=this;a(b.startButton).prop("disabled",!0),c._trigger("beforestart",null),a("<div>").appendTo(this.element).webcam(a.extend(this.options,{noCameraFound:function(){c._error("Web camera is not available")},swfApiFail:function(){c._error("Internal camera plugin error")},cameraDisabled:function(){c._error("Please allow access to your camera")},cameraEnabled:function(){c._cameraEnabled(this)}}))},stop:function(){var b=this.options;this._trigger("beforestop"),this.element.children().remove(),a(b.captureButton).prop("disabled",!0).off("click"),a(b.stopButton).hide().off("click"),a(b.startButton).prop("disabled",!1).show(),a(b.camerasSelect).parent().hide(),a(b.camerasSelect).children().remove(),b.isCameraEnabled=!1},_cameraEnabled:function(b){var c=this.options,d=this;c.isCameraEnabled||(c.isCameraEnabled=!0,c.cameraApi=b,setTimeout(function(){a(c.startButton).hide(),a(c.stopButton).show(),d._showCamerasSelect(),c.cameraApi.setCamera("0"),d._trigger("afterstart",null,{api:c.cameraApi,cameras:c.cameraApi.getCameraList()}),a(c.captureButton).prop("disabled",!1)},750),a(c.captureButton).click(function(a){a.preventDefault();var b=d.element.attr("id");d._trigger("beforeupload",null,{}),c.cameraApi.saveAndPost({url:c.postUrl,filename:c.filename,filefield:c.filefield,data:c.postData,js_callback:"(function (d) {jQuery('#"+b+"').photographer('postCallback', d);})"})}))},_showCamerasSelect:function(){var b=this.options,c=this,d=b.cameraApi.getCameraList();if(!(d.length<=1)){a(b.camerasSelect).parent().show();for(var e=0;e<d.length;e++)a("<option>").attr("value",e).text(d[e]).appendTo(b.camerasSelect);a(b.camerasSelect).change(function(){b.cameraApi.setCamera(a(this).val())||c._error("Unable to select camera")})}},_error:function(a){this._trigger("error",null,{message:a})},postCallback:function(a){this.stop(),this._trigger("afterupload",null,{text:a})},destroy:function(){this.stop(),a.Widget.prototype.destroy.call(this)},_random:function(){return Math.floor(99999*Math.random())}}),a.widget("avatars.uploader",{options:{attachmentId:1,attachmentsContainer:"#attachments_fields",fileFieldContainer:".add_attachment",thisSelector:".add_attachment"},_create:function(){var a=this;this.element.attr("id","uploader_"+this._random()),this.element.on("change","input[type=file]",function(){a.addInputFile(this)})},destroy:function(){a.Widget.prototype.destroy.call(this)},disable:function(){a(this.options.fileFieldContainer).find("input").prop("disabled",!0)},enable:function(){a(this.options.fileFieldContainer).find("input").prop("disabled",!1)},addInputFile:function(a){var b=this.options,c=a.value.split(/\/|\\/),d=c[c.length-1],e=b.attachmentId++,f=this.createInputField(d,e);this._ajaxUpload(a,d,f,e)},createInputField:function(b,c){var d=this.options,e=this,f=a("<span>",{id:"attachments_"+c});return a(d.fileFieldContainer).hide(),f.on("remove",function(){a(d.fileFieldContainer).show(),e._trigger("fileremove",null,{attachmentId:c})}),f.append(a("<input>",{type:"text","class":"filename readonly",name:"attachment[filename]",readonly:"readonly"}).val(b),a("<a>&nbsp</a>").attr({href:"#","class":"remove-upload"}).click(this._removeFile).hide()).appendTo(d.attachmentsContainer),f},successAfterUpload:function(b){var c=a("#attachments_"+b.attachmentId);c.append(a("<input>",{type:"hidden",name:"attachment[token]",value:b.token}),a("<input>",{type:"hidden",name:"attachment[content_type]",value:b.contentType})),c.find("a.remove-upload").attr({"data-remote":!0,"data-method":"delete",href:b.deletePath}).css("display","inline-block").off("click"),this._trigger("afterupload",null,b)},errorAfterUpload:function(a){this._trigger("error",null,a)},_ajaxUpload:function(b,c,d,e){var f=this.options,g=this,h=a(b).clone().val("");h.prependTo(f.fileFieldContainer);var i=a("<div>").insertAfter(d.find("input.filename"));i.progressbar(),d.addClass("ajax-waiting"),a("<form>").append(b).ajaxSubmit({type:"POST",url:g.element.data("upload-path"),data:{filename:c,attachment_id:e,uploader:"#"+g.element.attr("id")},dataType:"script",delegation:!0,beforeSend:function(a){a.setRequestHeader("Accept","application/js")},uploadProgress:function(a,b,c,d){i.progressbar("value",d)},beforeSubmit:function(){d.removeClass("ajax-waiting").addClass("ajax-loading"),a("input:submit",d.parents("form")).prop("disabled",!0)},success:function(){i.progressbar("value",100).remove()},error:function(a,b){i.text(b)},complete:function(){d.removeClass("ajax-loading"),a("input:submit",d.parents("form")).prop("disabled",!1),a(b).parent().remove()}})},_removeFile:function(b){b.preventDefault(),a(b.target).parent("span").remove()},_random:function(){return Math.floor(99999*Math.random())}})});
/* local_avatars.js; v20131228 https://github.com/thorin/redmine_local_avatars - license: GPL v2 */
jQuery(function(a){"use strict";function e(b){0==a("#errorExplanation").length&&a("<div>").attr({id:"errorExplanation"}).prependTo("#avatar-form"),a("#errorExplanation").text(b)}function f(){d.uploader("enable"),b.photographer("enable"),a(".crop-avatar, .capture-avatar").hide(),a(".blank-avatar").show()}function g(){d.uploader("disable"),a(".crop-avatar, .blank-avatar").hide(),a(".capture-avatar").show()}function h(e,f){b.photographer("disable"),d.uploader("disable"),f?(a(".blank-avatar, .capture-avatar").hide(),a(".crop-avatar").show(),c.cropper("start",e)):(a(".crop-avatar, .capture-avatar").hide(),a(".blank-avatar").show())}var b=a(".capture-avatar"),c=a(".crop-avatar"),d=a(".add_attachment");a("#delete-avatar").bind("ajax:success",function(){location.reload()}),c.cropper({cropX:"crop_x",cropY:"crop_y",cropW:"crop_w",cropH:"crop_h",previewContainer:"#preview-box"}),d.uploader({attachmentsContainer:"#attachments_fields",fileFieldContainer:".add_attachment",thisSelector:".add_attachment"}).bind("uploaderafterupload",function(a,b){h(b.attachmentPath,d.data("crop"))}).bind("uploaderfileremove",function(){f(),c.cropper("stop")}),b.photographer({startButton:"#start-webcam",stopButton:"#stop-webcam",captureButton:"#capture-webcam",camerasSelect:"#capture-cameras select",swffile:b.data("swffile"),filefield:"attachment[file]",filename:b.data("filename"),postUrl:b.data("upload-path"),postData:{filename:b.data("filename"),attachment_id:"capture",js_callback:b.data("js-callback"),authenticity_token:a("input[name=authenticity_token]").val(),uploader:"#"+d.attr("id")}}).bind("photographererror",function(a,b){e(b.message)}).bind("photographerbeforestart",g).bind("photographerbeforestop",f).bind("photographerbeforeupload",function(){d.uploader("createInputField",a(this).data("filename"),"capture")}).bind("photographerafterupload",function(b,c){a.globalEval(c.text.replace(/<\/?textarea>|/g,""))}),a.rails.href=function(a){var b=a.attr("href");return b?b:a.data("url")},a(document).delegate("input[type=button][data-remote]","click.rails",function(b){var c=a(this);return a.rails.allowAction(c)?(a.rails.handleRemote(c),!1):a.rails.stopEverything(b)})});