...
/* jQuery AS3 Webcam; v20140201 https://github.com/sshilko/jQuery-AS3-Webcam */
jQuery(function($){"use strict";var WebcamSwf=function(a,b){this.init(a,b)},WebcamGum=function(a,b){this.init(a,b)},WebcamBase={cameraEnabled:function(){return this.options.cameraEnabled.call(this)},cameraDisabled:function(){return this.options.cameraDisabled.call(this)},noCameraFound:function(){return this.options.noCameraFound.call(this)},isClientReady:function(){return this.options.isClientReady.call(this)},cameraReady:function(){return this.options.cameraReady.call(this)},error:function(a){return this.options.error.call(this,a)},debug:function(){return this.options.debug.call(this)},setUid:function(a){for(var b=a.attr("id");!b;){var c="webcam"+Math.floor(99999*Math.random());document.getElementById(c)||a.attr("id",b=c)}return b},getOptions:function(a){return $.extend({},$.fn.webcam.defaults,this.$element.data(),a)}};WebcamSwf.prototype=$.extend({},WebcamBase,{constructor:WebcamSwf,init:function(a,b){this.$element=$(a),this.id=setUid(this.$element),this.options=this.getOptions(b);var c="jQuery('#"+this.id+"').data('webcam')";this.$cam=$("<object>",{type:"application/x-shockwave-flash",data:this.options.swffile,width:this.options.previewWidth,height:this.options.previewHeight}).append($("<param>",{name:"movie",value:this.options.swffile}),$("<param>",{name:"allowScriptAccess",value:"always"}),$("<param>",{name:"bgcolor",value:this.options.bgcolor}),$("<param>",{name:"FlashVars",value:$.param({callTarget:c,resolutionWidth:this.options.resolutionWidth,resolutionHeight:this.options.resolutionHeight,smoothing:this.options.videoSmoothing,deblocking:this.options.videoDeblocking,StageScaleMode:this.options.StageScaleMode,StageAlign:this.options.StageAlign})})),this.$element.append(this.$cam),this.cam=this.$cam[0]},cameraConnected:function(){this.isSwfReady=!0,this.cameraReady()},save:function(){try{return this.cam.save()}catch(a){this.error(a)}},saveAndPost:function(a){try{return this.cam.saveAndPost(a)}catch(b){this.error(b)}},setCamera:function(a){try{return this.cam.setCamera(a)}catch(b){this.error(b)}},getCameraList:function(){try{return this.cam.getCameraList()}catch(a){this.error(a)}},getResolution:function(){try{return this.cam.getResolution()}catch(a){this.error(a)}},pause:function(){try{return this.cam.pause()}catch(a){this.error(a)}},resume:function(){try{return this.cam.resume()}catch(a){this.error(a)}}}),WebcamGum.prototype=$.extend({},WebcamBase,{constructor:WebcamGum,init:function(a,b){this.$element=$(a),this.id=this.setUid(this.$element),this.options=this.getOptions(b),this.$element.bind("webcamdestroy",$.noop),this.$wrapper=$("<div>",{css:{overflow:"hidden",maxWidth:"inherit",maxHeight:"inherit",width:this.options.previewWidth,height:this.options.previewHeight}}),this.$video=$('<video style="visibility:hidden" width="'+this.options.previewWidth+'" height="'+this.options.previewHeight+'" >'),this.$wrapper.append(this.$video),this.$element.append(this.$wrapper),this.$canvas=$("<canvas>"),this.video=this.$element.find("video")[0],navigator.getUserMedia({video:{mandatory:{minWidth:this.options.resolutionWidth,minHeight:this.options.resolutionHeight}},audio:!1},$.proxy(this.cameraConnected,this),$.proxy(this.cameraError,this))},cameraConnected:function(a){this.stream=a;var b=this.video;void 0!==b.mozSrcObject?b.mozSrcObject=a:b.src=window.URL&&window.URL.createObjectURL(a)||a,a.oninactive=function(){this.cameraDisabled()},b.play(),this.cameraReady(),this.$video.bind("loadeddata",$.proxy(this.checkVideo,this,10))},cameraError:function(a){("MANDATORY_UNSATISFIED_ERROR"==a||"MANDATORY_UNSATISFIED_ERROR"===a.name)&&this.noCameraFound(),this.error(a)},checkVideo:function(a){if(0>=a)return this.error("Unable to play video stream. Is webcam working?"),void 0;if(this.video.videoWidth<=0||this.video.videoHeight<=0)return window.setTimeout($.proxy(this.checkVideo,this,a-1),500),void 0;var b=this.video.videoWidth/this.video.videoHeight;this.$video.css({visibility:"inherit",width:Math.max(this.options.previewWidth,this.options.previewHeight*b),height:Math.max(this.options.previewHeight,this.options.previewWidth/b),marginLeft:Math.min(0,-(this.options.previewHeight*b-this.options.previewWidth)/2),marginTop:Math.min(0,-(this.options.previewWidth/b-this.options.previewWidth)/2)});var c=this.options.previewWidth/this.options.previewHeight;this.$canvas.attr({width:Math.min(this.video.videoWidth,this.video.videoHeight*c),height:Math.min(this.video.videoHeight,this.video.videoWidth/c)}),this.cameraEnabled()},saveAndPost:function(options){this.captureToCanvas(),this.canvaToBlob(function(blob){var formData=new FormData;formData.append(options.filefield,blob,options.filename),$.each(options.data,function(a,b){formData.append(a,b)});var self=this;$.ajax({url:options.url,data:formData,type:"POST",dataType:"text",processData:!1,contentType:!1,success:function(data){eval(options.js_callback)(data)},error:function(a,b,c){self.error(c)}})},"image/jpg",1)},save:function(){try{this.captureToCanvas();var a=this.$canvas[0].toDataURL("image/jpg",1);return this.$canvas.remove(),a.substring(a.indexOf(",")+1)}catch(b){this.error(b)}},canvaToBlob:function(a,b,c){if(this.$canvas.toBlob)return this.$canvas(a,b,c);for(var d=this.$canvas[0].toDataURL("image/jpg",1),e=d.match(/^data:([^;]+)(;base64)?,(.*)$/),f=atob(e[3]),g=new ArrayBuffer(f.length),h=new Uint8Array(g),i=0;i<h.length;i++)h[i]=f.charCodeAt(i);a(new Blob([h],{type:e[1]}))},captureToCanvas:function(){this.video.pause();var a=this.$canvas[0],b=a.getContext("2d"),c=a.width,d=a.height,e=(this.video.videoWidth-c)/2,f=(this.video.videoHeight-d)/2;b.drawImage(this.video,e,f,c,d,0,0,c,d),this.video.play()},setCamera:function(){return!0},getCameraList:function(){return[]},getResolution:function(){return[this.video.videoWidth,this.video.videoHeight]},pause:function(){this.video.pause()},resume:function(){this.video.play()},destroy:function(){void 0!==this.video.mozSrcObject?this.video.mozSrcObject=null:this.video.src=null,this.stream.stop()}}),navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia,window.URL=window.URL||window.webkitURL||window.mozURL||window.msURL;var Webcam;Webcam=navigator.getUserMedia?WebcamGum:WebcamSwf;var old=$.fn.webcam;$.fn.webcam=function(a){var b="string"==typeof a,c=Array.prototype.slice.call(arguments,1),d=this;return b?(this.each(function(){var b,e=$.data(this,"webcam");return e?"_"!==a.charAt(0)&&$.isFunction(e[a])?(b=e[a].apply(e,c),b!==e&&void 0!==b?(d=b&&b.jquery?d.pushStack(b.get()):b,!1):void 0):$.error("no such method '"+a+"' for webcam instance"):$.error("cannot call methods on webcam prior to initialization; attempted to call method '"+a+"'")}),d):this.each(function(){var b=$(this),c=b.data("webcam"),d="object"==typeof a&&a;c||b.data("webcam",c=new Webcam(this,d))})},$.fn.webcam.Constructor=Webcam,$.fn.webcam.defaults={previewWidth:320,previewHeight:240,resolutionWidth:320,resolutionHeight:240,videoDeblocking:0,videoSmoothing:0,bgcolor:"#000000",isCameraEnabled:!1,cameraEnabled:function(){},cameraDisabled:function(){},noCameraFound:function(){},isClientReady:function(){return!0},cameraReady:function(){},error:function(){},debug:function(){}},Webcam===WebcamSwf&&$.extend($.fn.webcam.defaults,{StageScaleMode:"exactFit",StageAlign:"",swffile:"sAS3Cam.swf"}),$.fn.webcam.noConflict=function(){return $.fn.webcam=old,this},$.event.special.webcamdestroy={teardown:function(){$(this).data("webcam").destroy()}}});
